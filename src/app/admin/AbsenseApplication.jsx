...
import AdminAbsenseApplicationMain from '../../assets/component/admin/AbsenseApplicationMain'

function AdminAbsenseApplication() {
  return (
    <>
    <Helmet>
...
export default AdminAbsenseApplication;