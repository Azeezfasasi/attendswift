...
const AdminMarkAttendanceMain = () => {
  ...
  return (
    <div className="container-bg-color container-border border bg-gray-100 p-6 rounded-lg shadow-md w-full">
      ...
      <h2 className="login-header-text text-lg font-semibold text-[#012970] mb-3">{t('Mark Attendance')}</h2>
        ...
        <table className="w-full border-collapse">
          ...
          <tbody className="text-gray-700 text-sm">
            {filteredStudents.length > 0 ? (
              ...
              <tr><td colSpan="5" className="login-label-text p-3 text-center text-gray-500">{t("No records found")}</td></tr>
            )}
          </tbody>
        </table>
