...
function AdminDashLeft() {
  ...
  return (
    ...
    {/* Sidebar */}
    <div className={`bg-[#ffffff] w-[300px] h-[350vh] lg:h-[800px] fixed top-[60px] lg:top-[0px] left-0 transform overflow-hidden ${menuOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-300 ease-in-out z-40 shadow-lg lg:relative lg:flex lg:flex-col`}>
