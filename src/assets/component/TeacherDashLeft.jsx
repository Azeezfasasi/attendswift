    ...
    <>
      ...
      <div className={`bg-[#ffffff] w-[300px] h-screen fixed top-[60px] lg:top-[0px] left-0 transform ${menuOpen ? 'translate-x-0' : '-translate-x-full'} lg:translate-x-0 transition-transform duration-300 ease-in-out z-40 shadow-lg lg:relative lg:flex lg:flex-col`}>
          <Link to="/" className="lg:hidden shrink-0 w-fit h-[26px] relative">
              <div className="text-[#012970] text-left font-['Nunito-Bold',_sans-serif] text-[20px] md:text-[26px] leading-[26px] font-bold  h-[35px] flex flex-row items-center justify-start ml-[40px] mt-[10px] mb-[-20px]">
                AttendSwift
              </div>
          </Link>
        ...
        <div className="flex flex-col p-5 space-y-2">
          ...
          <NavLink to="/app/admin/dashboard" className={({ isActive }) => `rounded w-[260px] h-11 flex relative items-center px-3 ${
